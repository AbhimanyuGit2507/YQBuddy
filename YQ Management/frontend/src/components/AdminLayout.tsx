  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black text-gray-900 dark:text-white flex overflow-hidden transition-colors">
      ...
      <div className="flex-1 flex flex-col h-screen relative">
        ...
        {/* Topbar */}
        <header className="h-16 flex items-center justify-end px-8 border-b border-gray-200 dark:border-white/10 bg-white/80 dark:bg-black/50 backdrop-blur-md z-10 shrink-0 transition-colors">
