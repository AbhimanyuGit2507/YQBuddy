...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black text-gray-900 dark:text-white flex overflow-hidden transition-colors">
      ...
      {/* Sidebar */}
      <aside className="w-64 border-r border-gray-200 dark:border-white/10 bg-white dark:bg-zinc-950 flex flex-col z-20 shrink-0 transition-colors">
      ...
      <div className="flex-1 flex flex-col h-screen relative">
        ...
        {/* Topbar */}
        <header className="h-16 flex items-center justify-end px-8 border-b border-gray-200 dark:border-white/10 bg-white/80 dark:bg-black/50 backdrop-blur-md z-[100] shrink-0 transition-colors">
              ...
              {userDropdownOpen && (
                <div className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-white/10 rounded-xl shadow-xl z-50 overflow-hidden">
                  <div className="px-4 py-3 border-b border-gray-200 dark:border-white/10">
                    ...
                    <p className="text-xs text-gray-500 dark:text-zinc-400 mt-0.5">{isAdmin ? 'Administrator' : 'Operator'}</p>
                  </div>
